...
#define BT_SOFT_ADJUST_LEVEL_H				(BT_SBC_DECODER_INPUT_LEN / 10 * 8)//8000
#define BT_SBC_LEVEL_HIGH					(BT_SOFT_ADJUST_LEVEL_H)
#define BT_SBC_LEVEL_LOW					(BT_SOFT_ADJUST_LEVEL_L)
#define BT_SBC_START_LEVEL					((BT_SBC_LEVEL_HIGH + BT_SBC_LEVEL_LOW) / 2 + 1024)//开播后1K左右数据被解码填解码器fifo
