...
/* 同步提供者回调：由 03_application_components/ble_app 层注册，
...
/**
 * @brief 同步帧发送（公共 API，供 03_application_components/ble_app 层调用）
 * @param cmd     命令字节
...
/**
 * @brief 注册同步提供者回调（由 03_application_components/ble_app 层调用）
