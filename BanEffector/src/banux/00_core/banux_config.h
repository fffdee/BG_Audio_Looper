...
/* Board-level product_def.h overrides the #ifndef defaults below. Include it
 * first so that framework files which include banux_config.h directly (Banux.h,
 * driver_init.c, drv_init.c, ...) still see the board switches (HW_DRV_*,
 * VFS_EN, EFFECT_GRAPHICS_EN, ...). The mutual include with product_def.h is
 * safe because both files are include-guarded. */
...
#define COMMAND_PARSER_EN           0   /* boot_app keeps only CDC shell + upgrade */
#endif
...
#define BANUX_GCODE_EN              0
#endif

#ifndef BANUX_WIRELESS_CONTROL_EN
#define BANUX_WIRELESS_CONTROL_EN   0   /* boot_app wireless stack is outside Banux */
#endif
...
#define BANUX_INTERNAL_FLASH_FS_EN  0   /* no Banux FatFs mount in boot_app */
#endif
...
#ifndef SYS_LED_EN
#define SYS_LED_EN                  0   /* sys_led component removed from app layer */
#endif

#ifndef EFFECT_GRAPHICS_EN
#define EFFECT_GRAPHICS_EN          0   /* effect component removed from app layer */
#endif
...
#define HW_DRV_BATTERY_EN          0   /* boot_app does not link Banux board drivers */
#endif

#ifndef HW_DRV_USB_CDC_EN
#define HW_DRV_USB_CDC_EN          0   /* composite USB uses otg_device_cdc directly */
#endif

#ifndef HW_DRV_BT_EN
#define HW_DRV_BT_EN               0   /* BT/BLE VFS drivers are not linked */
#endif
...
#define BANUX_FATFS_EN             0   /* FatFs component removed from boot_app */
#endif
 ...
 *===========================================================================*/
#if !defined(DBG) && !defined(CFG_APP_CONFIG)
#include <stdio.h>
