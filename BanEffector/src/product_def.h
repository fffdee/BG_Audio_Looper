...
/*===========================================================================
 * banux2 二代框架开关覆盖 (板级显式声明, 便于审计)
 *   - 无文件系统: FatFs / InternalFlashFs 关闭 (VFS_EN 已在上方置 0)
 *   - 无 3D 打印机残留: GCODE / 无线控制 关闭
 *   - SYS_LED_EN=0: LED 由 main.c 直接 GPIO 驱动 (sys_led 组件未启用)
 * 说明: banux_config.h 使用 #ifndef 防护, 以下定义在其被 include 之前生效,
 *       即为最终值; 与上方已定义的 VFS_EN/EFFECT_GRAPHICS_EN 不冲突。
 *===========================================================================*/
#define BANUX_FATFS_EN              0   /* 无 FatFs 文件系统 */
#define BANUX_INTERNAL_FLASH_FS_EN  0   /* 无内部 Flash 文件系统 */
#define BANUX_GCODE_EN              0   /* 无 G-code (3D 打印机残留) */
#define BANUX_WIRELESS_CONTROL_EN   0   /* 无线控制在 Banux 之外 (BLE 协议栈) */
#define SYS_LED_EN                  0   /* LED 直接 GPIO 驱动 */
