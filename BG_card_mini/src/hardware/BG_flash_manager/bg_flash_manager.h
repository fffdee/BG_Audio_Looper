...
#define DEV_NOR1  0   // First NOR Flash, CS = GPIOA21
#define DEV_NOR2  1   // Second NOR Flash, CS = GPIOA22

// Compatibility with legacy code
#define DEV_NOR     DEV_NOR1
#define DEV_NAND    DEV_NOR2

// First NOR Flash CS pin (GPIOA21)
...
// Second NOR Flash CS pin (GPIOA22)
...
// Macros for compatibility with legacy code
...
#define SECTOR_SIZE (4 * 1024*8) // Each sector size: 32KBit
...
#define NAND_PAGE_SIZE 2048  // W25N02 NAND Flash page size
...
#define NAND_CMD_PAGE_DATA_READ   0x13  // W25N02 Page Data Read command
#define NAND_CMD_RANDOM_DATA_READ 0x03  // W25N02 Random Data Read command
#define NAND_CMD_PROGRAM_LOAD     0x02  // W25N02 Program Load command
#define NAND_CMD_PROGRAM_EXECUTE  0x10  // W25N02 Program Execute command
#define NAND_CMD_BLOCK_ERASE      0xD8  // W25N02 Block Erase command
#define NAND_CMD_GET_FEATURE      0x0F  // W25N02 Get Feature command (read status)
#define NAND_CMD_SET_FEATURE      0x1F  // W25N02 Set Feature command (write status)
...
// NAND Flash smart audio functions
