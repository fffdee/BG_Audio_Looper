 ...
 * 
 * Manages partitioning and access for multiple Flash chips:
...
/* Internal layout of system settings partition */
#define SETTINGS_MAGIC_ADDR         0x000000    /* Magic value address */
#define SETTINGS_VERSION_ADDR       0x000004    /* Version address */
 ...
 * @return FLASH_OK on success, other values on failure
 */
 ...
 * @return Partition information pointer, NULL on failure
 */
 ...
 * @param type Partition type
 * @param offset Offset within partition (aligned to sector boundary)
 * @return FLASH_OK on success
 */
