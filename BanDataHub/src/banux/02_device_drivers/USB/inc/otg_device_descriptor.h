...
{
	// 閰嶇疆鎻忚堪绗� 2涓帴鍙�(CDC Control + CDC Data)
...
// CDC + Mass Storage (SD卡U盘) 复合设备
const uint8_t ConfigDescriptor_Tab(CDC_READER)[] =
{
	0x09,0x02,0x62,0x00,0x03,0x01,0x00,0x80,0x32,
	...
	0x07,0x05,DEVICE_MSC_IN_EP,0x02,DEVICE_FS_BULK_IN_MPS,0x00,0x01,
	0x07,0x05,DEVICE_MSC_OUT_EP,0x02,DEVICE_FS_BULK_OUT_MPS,0x00,0x01,
};
const uint8_t InterFaceNum_Tab(CDC_READER)[] = {0x02,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x01};


const uint8_t *ConfigDescriptorTab[14] =
{
	...
	ConfigDescriptor_Tab(CDC_READER),         // 13 CDC+MassStorage
};

const uint8_t *InterFaceNumTab[14] =
{
	...
	InterFaceNum_Tab(CDC_ONLY),          // 10
	InterFaceNum_Tab(AUDIO_MIC_CDC),     // 11
	InterFaceNum_Tab(CDC_ONLY),          // 12
	InterFaceNum_Tab(CDC_READER),        // 13 CDC+MassStorage
};
