...
#else /* HW_DRV_BATTERY_EN == 0 */

uint8_t battery_get_soc(void)
{
    return 100u; /* No battery, return full SOC */
}

uint16_t battery_get_volt_mv(void)
{
    return 4200u; /* No battery, return nominal voltage */
}

float battery_get_volt(void)
{
    return 4.2f; /* No battery, return nominal voltage */
}
