...
#ifdef BANDATAHUB
/* BanDataHub: no NOR/NAND Flash, skip CS/WP pin init to avoid conflict */
#define FLASH_NOR0_CS_INIT()    do {} while(0)
#define FLASH_NOR0_CS_ENABLE()  do {} while(0)
#define FLASH_NOR0_CS_DISABLE() do {} while(0)
#define FLASH_NOR1_CS_INIT()    do {} while(0)
#define FLASH_NOR1_CS_ENABLE()  do {} while(0)
#define FLASH_NOR1_CS_DISABLE() do {} while(0)
#define FLASH_NAND0_CS_INIT()   do {} while(0)
#define FLASH_NAND0_CS_ENABLE()  do {} while(0)
#define FLASH_NAND0_CS_DISABLE() do {} while(0)
#define FLASH_WP_INIT()         do {} while(0)
#define FLASH_WP_ENABLE()       do {} while(0)
#define FLASH_WP_DISABLE()      do {} while(0)
#else
