...
#ifdef BANDATAHUB
/* BanDataHub: no NOR/NAND Flash, skip CS/WP pin init */
#define NOR1_CS_INIT()
#define NOR1_CS_ENABLE()
#define NOR1_CS_DISABLE()
#define NOR2_CS_INIT()
#define NOR2_CS_ENABLE()
#define NOR2_CS_DISABLE()
#define FLASH_CS_INIT()
#define FLASH_CS_ENABLE()
#define FLASH_CS_DISABLE()
#define NAND_CS_INIT()
#define NAND_CS_ENABLE()
#define NAND_CS_DISABLE()
#define FLASH_WP_INIT()
#define FLASH_WP_ENABLE()
#define FLASH_WP_DISABLE()
#else
