...
C_SRCS += \
../src/banux/01_hal_drivers/gpio/rotary_encoder.c 

OBJS += \
./src/banux/01_hal_drivers/gpio/rotary_encoder.o 

C_DEPS += \
./src/banux/01_hal_drivers/gpio/rotary_encoder.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/01_hal_drivers/gpio/%.o: ../src/banux/01_hal_drivers/gpio/%.c
	@echo '正在构建文件： $<'
