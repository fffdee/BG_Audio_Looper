...
C_SRCS += \
../src/banux/01_hal_drivers/adc/audio_setting.c 

OBJS += \
./src/banux/01_hal_drivers/adc/audio_setting.o 

C_DEPS += \
./src/banux/01_hal_drivers/adc/audio_setting.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/01_hal_drivers/adc/%.o: ../src/banux/01_hal_drivers/adc/%.c
	@echo '正在构建文件： $<'
