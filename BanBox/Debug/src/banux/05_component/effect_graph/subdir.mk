...
OBJS += \
./src/banux/05_component/effect_graph/chain_graph_apply.o \
...
C_DEPS += \
./src/banux/05_component/effect_graph/chain_graph_apply.d \
...
src/banux/05_component/effect_graph/%.o: ../src/banux/05_component/effect_graph/%.c
	@echo '正在构建文件： $<'
