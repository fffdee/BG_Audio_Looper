...
//****************************************************************************************
//				   ��Ч��������	   
//1.ɽ����Ч�㷨��������ʵ�֣���˿��������Чʱ����Ҫ����ϵͳ��Դ���������
//    �������������ACPWorkbench�е���Դ����״̬����Ӧ,����MCPSStart��MCPSStop������ȡ;
//2.Ĭ����Ч������audio_effect.h�У�
//3.������ر�������Ч��(�رպ�ACPWorkbench�����϶�Ӧ�ĵ���Ч�᲻��ʾ���ҵ�����xxxx.c������Ĵ�С��ı䣻
//4.�����������·���:
//    1)���ߵ����󣬿���ACPWorkbench����ֱ�����ص�flash��?
//    2)�򵼳����滻sdk��effect_parameter��xxxx.c;
...
#define  CFG_AUDIO_EFFECT_MUSIC_3D_PLUS_EN               (1)//����Чֻ������BP1048P2��BP1064�ͺ�оƬ
...
#define  CFG_AUDIO_EFFECT_MIC_AEC_EN	                 (1)//Ŀǰֻ֧��8K,16K������
#else
#define  CFG_AUDIO_EFFECT_MIC_AEC_EN	                 (0)//Ŀǰֻ֧��8K,16K������
#endif
...
#define CFG_MIC_ECHO_DELAY                              ( 750)  //200 ms(10143)  //230 ms
#define CFG_MIC_ECHO_ATTENUATION                        (14636)  //-7 dB
#define CFG_MIC_ECHO_DIRECT_SND_EN                      (    1)
#define CFG_MIC_ECHO_CUTOFF_FREQ                        ( 2000)  //2000 Hz

#define CFG_MIC_REVERB_DRY_SCALE                        (   100)
#define CFG_MIC_REVERB_WET_SCALE                        (  50)
#define CFG_MIC_REVERB_WIDTH_SCALE                      (  60)
#define CFG_MIC_REVERB_ROOM_SIZE                        (   70)
#define CFG_MIC_REVERB_DAMPING                          (   45)

#define CFG_MIC_PLATEREVERB_HIGHCUT_FREQ                ( 20000)  //20000 Hz
#define CFG_MIC_PLATEREVERB_MODULATION_EN               (   1)
#define CFG_MIC_PLATEREVERB_PREDELAY                    (   10)
#define CFG_MIC_PLATEREVERB_DIFFUSION                   (   20)
#define CFG_MIC_PLATEREVERB_DECAY                       (   30)
#define CFG_MIC_PLATEREVERB_DAMPING                     (    3)
#define CFG_MIC_PLATEREVERB_WETDRYMIX                   (   30)
