...
#define BT_NAME						"BanBox"
#define BT_NAME_SIZE				40//���֧��name size,�����޸�
#define BT_ADDR_SIZE				6

// 原始值0x16，针对有问题批次的板子调整补偿值
// 如果低温时卡顿，尝试 0x14-0x18 范围内调整
#define BT_TRIM						0x14  // 降低补偿值，适应低温晶振频率偏移

#define BT_PINCODE					"0000"

#define BT_TX_POWER_LEVEL			23	//23:max tx power level(max:8db / -2db step)
