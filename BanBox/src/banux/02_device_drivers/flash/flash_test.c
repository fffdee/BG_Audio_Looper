/**
 * flash_test.c - 鏂�Flash 椹卞姩鏋舵瀯娴嬭瘯浠ｇ爜
 * 娴嬭瘯 flash_bus + flash_devices + flash_nor_w25qxx 鏋舵瀯
 */
...
{
    FlashDevInfo_t info;
    uint32_t test_address = 0x1000; /* 浣跨敤绗簩涓�K鎵囧尯 */
    uint16_t i;
    bool result = true;
