...
/*===========================================================================
 * BanBox Large Font Data (24x24 per character)
 *===========================================================================*/
/* Custom large font for "BanBox" display */
static const uint8_t BanBox_Font[][72] = {
    /* 'B' - 24x24 */
    {
        0xFF, 0xFF, 0xF0,  0xFF, 0xFF, 0xF0,  0xC0, 0x00, 0x30,
        0xC0, 0x00, 0x30,  0xC0, 0x00, 0x30,  0xC0, 0x00, 0x30,
        0xC0, 0x00, 0x30,  0xFF, 0xFF, 0xE0,  0xFF, 0xFF, 0xE0,
        0xC0, 0x00, 0x70,  0xC0, 0x00, 0x30,  0xC0, 0x00, 0x30,
        0xC0, 0x00, 0x30,  0xC0, 0x00, 0x30,  0xC0, 0x00, 0x30,
        0xC0, 0x00, 0x70,  0xFF, 0xFF, 0xE0,  0xFF, 0xFF, 0xC0,
    ...
    /* 'a' - 24x24 */
    {
        ...
        0x1F, 0xFF, 0x80,  0x30, 0x01, 0xC0,  0x00, 0x01, 0xC0,
        0x00, 0x01, 0xC0,  0x0F, 0xFF, 0xC0,  0x3F, 0xFF, 0xC0,
        0x70, 0x01, 0xC0,  0xE0, 0x01, 0xC0,  0xE0, 0x01, 0xC0,
        0xE0, 0x03, 0xC0,  0x7F, 0xFF, 0xC0,  0x3F, 0xFD, 0xC0,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
    },
    /* 'n' - 24x24 */
    {
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xCF, 0xF8, 0x00,
        0xDF, 0xFC, 0x00,  0xF8, 0x0E, 0x00,  0xE0, 0x07, 0x00,
        0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,
        0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,
        0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,  0xE0, 0x07, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
    ...
    /* 'o' - 24x24 */
    {
        ...
        0x1F, 0xFC, 0x00,  0x38, 0x0E, 0x00,  0x70, 0x07, 0x00,
        0x60, 0x03, 0x00,  0xE0, 0x03, 0x80,  0xE0, 0x03, 0x80,
        0xE0, 0x03, 0x80,  0x60, 0x03, 0x00,  0x70, 0x07, 0x00,
        0x38, 0x0E, 0x00,  0x1F, 0xFC, 0x00,  0x0F, 0xF8, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
    },
    /* 'x' - 24x24 */
    {
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0xE0, 0x07, 0x00,
        0x70, 0x0E, 0x00,  0x38, 0x1C, 0x00,  0x1C, 0x38, 0x00,
        0x0E, 0x70, 0x00,  0x07, 0xE0, 0x00,  0x03, 0xC0, 0x00,
        0x07, 0xE0, 0x00,  0x0E, 0x70, 0x00,  0x1C, 0x38, 0x00,
        0x38, 0x1C, 0x00,  0x70, 0x0E, 0x00,  0xE0, 0x07, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,  0x00, 0x00, 0x00,  0x00, 0x00, 0x00,
    },
};

static void draw_banbox_large_char(uint16_t x, uint16_t y, uint8_t char_index, uint16_t color)
{
    uint8_t row, col, byte_idx, bit_idx;
    
    for (row = 0; row < 24; row++) {
        for (col = 0; col < 24; col++) {
            byte_idx = row * 3 + (col / 8);
            bit_idx = 7 - (col % 8);
            
            if (BanBox_Font[char_index][byte_idx] & (1 << bit_idx)) {
                Gui_DrawPoint(x + col, y + row, color);
            }
        }
    }
}
...
//
//    /* Draw "BanBox" text in white box (24x24 custom large font) */
//    /* Character mapping: B=0, a=1, n=2, B=0, o=3, x=4 */
//    const uint8_t banbox_chars[6] = {0, 1, 2, 0, 3, 4}; /* "BanBox" */
//    uint16_t char_width = 24;
//    uint16_t total_width = 6 * char_width;  /* 6 chars * 24 width = 144 */
//    uint16_t text_x = (UI_SCREEN_WIDTH - total_width) / 2;  /* Center horizontally */
//    uint16_t text_y = UI_STATUSBAR_HEIGHT + 11;  /* Vertical center in 46px box */
//    uint16_t j, x_pos = text_x;
//

//    for (j = 0; j < 6; j++) {
//        draw_banbox_large_char(x_pos, text_y, banbox_chars[j], 0xFFFF);
//        x_pos += char_width;
//    }
    show_main_icon(0,12,160,59,gImage_BanBox);
