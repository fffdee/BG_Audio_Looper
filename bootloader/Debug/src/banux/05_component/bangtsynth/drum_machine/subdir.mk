...
C_SRCS += \
../src/banux/05_component/bangtsynth/drum_machine/drum_machine.c 

OBJS += \
./src/banux/05_component/bangtsynth/drum_machine/drum_machine.o 

C_DEPS += \
./src/banux/05_component/bangtsynth/drum_machine/drum_machine.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/05_component/bangtsynth/drum_machine/%.o: ../src/banux/05_component/bangtsynth/drum_machine/%.c
	@echo '正在构建文件： $<'
