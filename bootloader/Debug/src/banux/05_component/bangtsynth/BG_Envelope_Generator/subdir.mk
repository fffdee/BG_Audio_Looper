...
C_SRCS += \
../src/banux/05_component/bangtsynth/BG_Envelope_Generator/bg_envelope.c 

OBJS += \
./src/banux/05_component/bangtsynth/BG_Envelope_Generator/bg_envelope.o 

C_DEPS += \
./src/banux/05_component/bangtsynth/BG_Envelope_Generator/bg_envelope.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/05_component/bangtsynth/BG_Envelope_Generator/%.o: ../src/banux/05_component/bangtsynth/BG_Envelope_Generator/%.c
	@echo '正在构建文件： $<'
