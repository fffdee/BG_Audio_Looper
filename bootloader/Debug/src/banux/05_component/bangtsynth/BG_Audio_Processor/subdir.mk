...
C_SRCS += \
../src/banux/05_component/bangtsynth/BG_Audio_Processor/bg_audio_processor.c 

OBJS += \
./src/banux/05_component/bangtsynth/BG_Audio_Processor/bg_audio_processor.o 

C_DEPS += \
./src/banux/05_component/bangtsynth/BG_Audio_Processor/bg_audio_processor.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/05_component/bangtsynth/BG_Audio_Processor/%.o: ../src/banux/05_component/bangtsynth/BG_Audio_Processor/%.c
	@echo '正在构建文件： $<'
