...
C_SRCS += \
../src/banux/02_device_drivers/bluetooth/bt_vfs_driver.c 

OBJS += \
./src/banux/02_device_drivers/bluetooth/bt_vfs_driver.o 

C_DEPS += \
./src/banux/02_device_drivers/bluetooth/bt_vfs_driver.d 


# Each subdirectory must supply rules for building sources it contributes
src/banux/02_device_drivers/bluetooth/%.o: ../src/banux/02_device_drivers/bluetooth/%.c
	@echo '正在构建文件： $<'
