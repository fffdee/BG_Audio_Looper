...
static const uint8_t DmaChannelMap[29] = {
	...
	255,//PERIPHERAL_ID_SDPIF_RX,			//8 SPDIF_RX /TX闇�浣跨敤鍚屼竴閫氶亾
...
#define	DAC1_FIFO_LEN					(256 * 4)
uint32_t DAC1FIFO[DAC1_FIFO_LEN/4];
...
{
	/* DMA channel allocation is owned by main.c which merges all peripherals.
	 * Do NOT call DMA_ChannelAllocTableSet here. */
